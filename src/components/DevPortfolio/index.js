			...
			<Container className="project boder border-3">
				...
				<Row className="project-2 py-3">
					<Col className="border border-2 project-col">
						...
						<p>
							...
							they've eaten, exercise, and sleep for a given day. The data is
							then graphed before beign presented back to the user so that they
							can determine which habits have the greatest benefits.
						</p>
						<a
				...
				<Row className="project-2 py-3">
					<Col className="border border-2 project-col">
						...
						<p>
							&ensp;A Mongoose based social media backend, which creates models
							to manage a platform's MongoDB database. It includes controllers,
