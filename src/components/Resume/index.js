...
import "./index.scss";
import resume from "../../assets/resume/a.wilkins.resume.pdf";
...
const Hero = () => {
	...
	return (
		<div className="resume">
			<h3 className="mt-3 text-center">Resume</h3>
				...
				<Row className="resume-row">
					<Col className="text-center mt-3">
						...
						<p className="text-start">
							...
							experience in Michelin-Starred New York City restaurants, which
							have led to a personable, friendly demeanor as well as leadership
						...
						<p className="text-start">
							...
							<ul>
								...
								<li>
									Role: Created Back-End and refactored the code to make the app
									a PWA
								</li>
							</ul>
						</p>
						<p className="text-start">
							...
							<ul>
								<li>
									...
									Bootstrap, React, React Bootstrap, JSON Web Token, React
									Router
								</li>
								<li>
									Role: Created Mongoose models, styled CSS, and facilitated
									group meetings
								</li>
							</ul>
						</p>
						...
						<p className="text-start">
							...
							<ul>
								...
								<li>
									Authored posts that included photography to paint a rich
									picture of what travel to certain places was like
								</li>
								<li>
						...
						<p className="text-start">
							...
							<ul>
								<li>
									Contributed to the team by learning all front of house roles
									and filling in where needed
								</li>
								<li>
									Consistently upsold menu items and dining experiences to
									create a better experience for the patrons
								</li>
								<li>
